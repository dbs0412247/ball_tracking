...
// file automatically generated by catkin during catkin_make
#include "ball_tracking/CamshiftOutput.h"
...
// Private variable declarations
  ...
  ros::Publisher pub_CamshiftOutput_;
...
public:
  MeanShiftTracker()
    ...
    pub_CamshiftOutput_ = nh_.advertise<ball_tracking::CamshiftOutput>("/meanshift_tracker/camshift_output", 10); 
//    pub_CamshiftOutput_ = it_.advertise("/meanshift_tracker/camshift_output", 10); 
  ...
  void imageCb(const sensor_msgs::ImageConstPtr& msg)
  {
    ...
    if (!paused) {      
      ...
      if (trackObject) {
        ...
        // publish time-stamped msgs on tracked object
        ball_tracking::CamshiftOutput output;
        ros::Time time = ros::Time::now();
        output.header.stamp = time;
        output.center_x = trackBox.center.x;
        output.center_y = trackBox.center.y;
        output.size_width = trackBox.size.width;
        output.size_height = trackBox.size.height;
        output.angle = trackBox.angle;
        pub_CamshiftOutput_.publish(output);
